document.addEventListener('DOMContentLoaded', function () {
    ...
    function openEditOrganizationModal(org) {
      ...
      organizationForm['org-site-name'].value = org.user_name
      organizationForm['org-admin-name'].value = org.user_name;
      organizationForm['org-site-name'].value = org.site_name;
    ...
    organizationForm.addEventListener('submit', function (e) {
      ...
      const newOrg = {
        ...
        site_name: organizationForm['org-site-name'].value,
    ...
    function createAdminUser(org) {
      ...
      const requestBody = {
        ...
        organizationName: org.site_name,
